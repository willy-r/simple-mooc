...
def post_save_announcement(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        # This open a new connection each time that send an e-mail to a user.
